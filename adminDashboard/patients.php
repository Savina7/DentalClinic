            ...
            <tbody>
                <?php if (count($patients) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            // Shfaq plain password nëse ekziston në session
                            if (isset($_SESSION['new_patient_password'][$p['email']])) {
                                echo htmlspecialchars($_SESSION['new_patient_password'][$p['email']]);
                            } else {
